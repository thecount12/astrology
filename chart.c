...
/*
cpu% ./chart 1974 taurus 30.00 `{./hms 4:16 am} 05/18 36.33N 119.95W \
	57.19 20.57 72.71 15.45 107.18 344.27 94.26 | pic | troff | page -w

./chart 1995 taurus 14.25 | pic | troff | page -w
./chart 1995 taurus 14.25 14:30 05/12 45.50N 73.56W | pic | troff | page -w
*/
...
main(int argc, char *argv[])
{
	...
	/*
	 * Planets: read the last seven argv words (tropical longitudes).
	 * Works regardless of how many metadata fields precede them.
	 */
	if(argc > 8) {
	...
	/* argv[4]=local time  argv[5]=MM/DD  argv[6]=lat  argv[7]=lon */
	print(".PS\n");
	print("\"\\fBClassical Sidereal Chart\\fP\" at 0,3.6\n");
	print("\"DOB: %s/%d  Time: %s local\" at 0,3.4\n", argv[5], birth_year, argv[4]);
